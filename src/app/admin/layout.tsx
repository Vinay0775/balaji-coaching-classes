...
import Header from '@/components/dashboard/Header'; // We can reuse the student header since it adapts to session
  ...
  return (
    <div className="min-h-screen bg-[#060910] text-white flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden bg-[#060910] relative">
        <div className="absolute top-0 right-0 w-[800px] h-[500px] bg-indigo-900/10 rounded-full blur-[150px] pointer-events-none" />
        
        <Header onMenuClick={() => setSidebarOpen(true)} />
        
        <main className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-6 lg:p-10 relative z-10">
          {children}
        </main>
      </div>
    </div>
